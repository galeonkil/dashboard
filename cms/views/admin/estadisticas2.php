...
$datos=new EstadisticasController();
$respuesta=$datos->ctrlListarCalificacionTiempo();

?>
<div class="container-fluid contenedor">
    <div class="row encabezado">
        <div class="col-12 bg-warning">
            <h2 class="">Average Qualification vs time in courses</h2>
    ...
    <div class="row">
        <div class="col mt-2">
            <div class="graficos">
                <div class="card-header text-center bg-success">Average Qualification vs time in courses</div>
...
const datosVentas2020 = {
    label: "Average Qualification vs time in course",
    data: [
        <?php
        foreach($respuesta as $key){
            echo "{x:".$key['TiempEnCursosHrs'].","."y:".$key['CalificaciónMedia']."},";
