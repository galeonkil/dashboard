<nav id="side-nav" class="side_nav p-0">
  <div class="d-flex justify-content-end justify-content-lg-start align-items-center side__nav__head">
    <h1 class="m-0 pl-3 d-none d-lg-block side__nav--title"><?php echo "DASHBOARD"; ?></h1>
  ...
  <ul class="m-0 p-0">
    ...
    <li class="mt-1 mb-1">
      <a href="index.php?page=publicar" class="d-flex align-items-center side__nav--link">
        <i class="fas fa-pencil-alt side__nav--icon nav-item-icon"></i>publications
      </a>
    </li>
   ...
   <!-- <li class="mt-1 mb-1">
    ...
    <li class="mt-1 mb-1">
      <a href="index.php?page=estadisticas" class="d-flex align-items-center side__nav--link">
        <i class="bi icon-chart-bar-outline side__nav--icon nav-item-icon"></i>statistics
      </a>
    </li>

    <!--<li class="mt-1 mb-1">
        <a href="#" class="d-flex align-items-center side__nav--link">
            <i class="fas icon-comment-1 side__nav--icon nav-item-icon"></i>
            Comentarios
        </a>
    </li>-->
   <!-- <li class="mt-1 mb-1">
